      ...
      steps: [
        ...
        { label: "Converge on 4", dur: 1.1,
          throws: [
            ...
            { from: { team: "us", n: 10 }, to: { team: "them", n: 4 }, curve: -32 },
          ] },
      ],
    },
    ...
    "crash": {
      ...
      steps: [
        { label: "They throw — corners crash", dur: 1.1,
          moves: [
            { team: "us", n: 1, to: [38, 54] },
            { team: "us", n: 10, to: [54, 54] },
          ] },
        { label: "Both attack the thrower", dur: 1.0,
          throws: [
            { from: { team: "us", n: 1 }, to: { team: "them", n: 5 }, curve: -22 },
            { from: { team: "us", n: 10 }, to: { team: "them", n: 5 }, curve: -14 },
          ] },
      ],
    },
  };
